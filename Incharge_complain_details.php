...
<head>
    ...
    if(isset($_POST['assign']))
    {
      if($_SERVER["REQUEST_METHOD"]=="POST")
      {
        ...
        $pid=$_POST['p_id'];
        // echo $pid;die;
        $res1=mysqli_query($conn,"SELECT p_id FROM police where p_id='$pid'");
        ...
        // echo "update complaint set inc_status='Assigned',pol_status='In Process',p_id='$pid' where c_id='$cid'";die;
...
?>
 ...
 <div>  
<form method="post">
<select class="form-control" name="p_id" style="margin-left:40%; width:250px;">
            <?php
                        $p_name = mysqli_query($conn, "select p_id, p_name from police where location='$location'");
