        ...
        <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                  <div class="navbar-header">
                    <a class="navbar-brand" href="#">CrimeAlert</a>
                  </div>
              ...
              <div class="container">
                     ...
                     <form class="form-horizontal" id="frm_data">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-10 col-offset-2" style="text-align:center;">
                            <a href="headHome.php">
                            <input type="button" href="headHome.php" name="button" class="btn btn-danger" value="Cancel"/></a>
                            </div>
                            <div class="col-md-10 col-offset-2" style="text-align:Right;">
                            <a href="headHome.php">
                            <input type="button" href="headHome.php" name="button" class="btn btn-danger" value="GO BACK"/></a>
                            </div>
