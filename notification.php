     ...
     ?>
        <nav class="navbar navbar-default navbar-fixed-top">
              ...
              <div class="form-group row">
                            ...
                            <br><br><br><br><br><br><br><br><br><h1>Click up to be Notified &nbsp &nbsp<i class="fa fa-hand-o-up" aria-hidden="true" ></i></h1><br><br>
                            <a href="home.php">
                            <input type="button" href="home.php" name="button" class="btn btn-danger" value="Go Back"/></a>
                            </div>
