...
<head>
    ...
    header("location:head_view_police_station.php");
    {
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $q1=mysqli_query($conn,"delete from police_station where i_id='$iid'");
...
<?php
 ...
 <form style="margin-top: 5%; margin-left: 40%;" method="post">
      <input type="text" name="iid" style="width: 250px; height: 30px; background-color:white;" placeholder="&nbsp Incharge Id" id="ciid" onfocusout="f1()" required>
        <div>
      <input class="btn btn-danger" type="submit" value="Delete Incharge" name="s2" style="margin-top: 10px; margin-left: 9%;">
        </div>
    </form>
