...
<head>
    ...
    header("location:userlogin.php");
        ...
        $u_id=$_SESSION['u_id'];
        $result1=mysqli_query($conn,"SELECT c_no FROM user where u_id='$u_id'");
    ...
    if(isset($_POST['s2']))
    {
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $resu=mysqli_query($conn,"SELECT c_no FROM complaint where c_id='$cid'");
    ...
    $query="select c_id,type_crime,d_o_c,location from complaint where c_no='$c_no' order by c_id desc";
...
<?php
    ...
    <tbody style="background-color: white; color: black;">
      <tr>
        ...
        <td><a href="complainer_complain_details.php?id" class="btn btn-primary">View</a></td>    
      </tr>
    </tbody>
